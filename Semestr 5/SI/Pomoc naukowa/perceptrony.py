...
X = [x1, x2]
weights = [w10, w11, w12, w20, w21, w22] #rozwiązanie będzie szukane poprzez zmienianie wartości tych zmiennych
solve(X=X, weights=weights, output_node=second_node, weights_decimal_places=0, truth_table=TRUTH_TABLE)