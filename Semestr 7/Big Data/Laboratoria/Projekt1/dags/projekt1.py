...
with DAG(
  ...
  mapreduce_classic = BashOperator(
    ...
    bash_command="""hadoop jar {{ params.dags_home }}/project_files/motorvehiclecollisions.jar MotorVehicleCollisions {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
  )
